  ...
  return (
    <div className="flex gap-5 lg:gap-6 items-center">
      {profile.images && profile.images[0] ? (
        ...
        <div className="w-24 h-24 lg:w-28 lg:h-28 rounded-full bg-gray-700 flex items-center justify-center flex-shrink-0">
      ...
      <div>
        <h3 className="text-2xl lg:text-3xl font-semibold mb-3 lg:mb-4 text-white">{profile.display_name || 'Spotify User'}</h3>
