...
import { getSavedAlbums, getFollowedArtists, getUserPlaylists, refreshAccessToken } from '@/lib/spotify';
...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      return NextResponse.json({
        totalSavedAlbums: albumsData.total,
        totalFollowedArtists: artistsData.total,
